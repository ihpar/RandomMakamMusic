				...
				<div class="col-md-12 portfolio-item">
					<form>
						...
						<div class="form-group">
							...
							<div class="btn-group btn-group-justified" data-toggle="buttons">
								<input id="musicality" data-slider-id="musicalitySlider" type="text" data-slider-min="1" data-slider-max="10" data-slider-step="1" data-slider-value="5" data-slider-tooltip="hide" />
							</div>
						...
						<div class="form-group">
							<div id="dvSongHolder" style="height: 5px;">
								<div id="dvLoader" style="display: none;">
									...
									COMP<img src="images/loading.gif" />SING...</div> 
								</div>
